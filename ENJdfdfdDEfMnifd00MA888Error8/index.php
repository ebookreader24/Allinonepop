...
<head>
	<script defer src="https://cloud.umami.is/script.js" data-website-id="cfbccf0d-68cd-43eb-a82f-3dd2d4a0ec2f"></script>
...
<script>
  ...
  gtag('config', 'G-5VCKJZPF1D');
	...
	<title>Apple Security Center Er#0x268d07</title>
		...
		<div class="row">
				...
				<div class="right-foot" style="text-align:center;margin-bottom: 5px;">
					...
					<span style="font-weight:500;padding-left:13px;color:#fff; ">Call Apple Support: <span
							style="border:1px solid #fff;border-radius:5px;padding:4px 5px"> <img src="winlo.png" alt=""
								style="width: 25px;vertical-align: sub;"> Call us directly 1-800-654-0175 
			...
			<div class="col-md-12">
				<marquee direction="left" height="100px" width="100%">
					<small class="text-left" style="color:#eee;font-size:10px">Apple SmartScreen now prevents
						unrecognized applications from appearing. system may be at risk. A Apple scan found
						adware on
		...
		<div class="ilb top" style="font-size:17px">
			<div class="ilb headers" style="border-bottom:1px solid #d6d5d5">
				<span class="fl title" id="txtadd">
					...
					</span>Apple Security Center </span>
...
<div id="error" style="color:red;"></div>
		...
		<div id="disclaimer">Access to this system is blocked for security reasons. <br>
			<span class="support" style="font-size:22px;">Call Apple Security Toll Free: 1-800-654-0175 <br><span
	...
	<div class="cardcontainer" style="cursor: none; display: block;" id="pop_up_new">
		<p style="font-size:16px;font-weight:400;margin:0;margin-bottom:5px;padding:5px 10px;color:#fff!important;color:#414141;font-weight:700;margin-top:8px"
			class="text-center">Apple - Security Warning</p>
		<p>
		...
		<p>Apple scan found adware on this device that can steal passwords, online identities, financial
...
<strong>
 1-800-654-0175 
	...
	<div class="answer_list"
		...
		<p style="color:#fff;margin-top:10px;font-size:16px;padding:0 5px" class="text-center">Please contact us
			...
			<strong>Call Apple Support: <span style="border:1px solid #383d41;border-radius:5px;padding:6px 5px"> <img
						src="winlo.png" alt="&nbsp" style="width: 25px;vertical-align: bottom;"> Call us directly  1-800-654-0175 
	...
	<div id="chat" style="display: block;">
		<img src="msmm.png">
		<span
			style="color:#222;font-size:24px;font-weight:600;margin-left:6px;position:relative;top:5px">Apple</span>
...
<!-- Mirrored from pokk4.z12.web.core.Apple.net/werrx01USAHTML/?bcda=1-888-682-6149 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Nov 2024 20:55:32 GMT -->
</html>
